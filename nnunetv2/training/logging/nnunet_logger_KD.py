...
class nnUNetLogger_KD(object):
    ...
    def __init__(self, verbose: bool = False):
        self.my_fantastic_logging = {
            ...
            'train_losses': list(),
            'student_train_losses': list(),
            'teacher_train_losses': list(),
            'val_losses': list(),
            'lrs': list(),
    ...
    def plot_progress_png(self, output_folder):
        ...
        # val_loss, student_loss, teacher_loss
        ax = ax_all[1]
        ax.plot(x_values, self.my_fantastic_logging['val_losses'][:epoch + 1], color='r', ls='--', label="loss_val", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['train_losses'][:epoch + 1], color='b', ls='dotted', label="loss_tr", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['student_train_losses'][:epoch + 1], color='darkorange', ls='-', label="loss_student", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['teacher_train_losses'][:epoch + 1], color='y', ls='-', label="loss_teacher", linewidth=4)
        ax.set_xlabel("epoch")
        ax.set_ylabel("loss")

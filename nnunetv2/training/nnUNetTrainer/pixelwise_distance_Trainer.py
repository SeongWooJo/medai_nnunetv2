...
class pixelwise_distance_Trainer(nnUNetTrainer):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if 0 else dummy_context():
            ...
            tumor_distance = torch.norm(teacher_tumor_vector - student_tumor_vector, p=2, dim=1)
            kidney_distance = torch.norm(teacher_kidney_vector - student_tumor_vector, p=2, dim=1)

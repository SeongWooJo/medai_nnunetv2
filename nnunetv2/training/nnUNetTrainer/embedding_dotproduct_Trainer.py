...
class embedding_dotproduct_Trainer(nnUNetTrainer):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if 0 else dummy_context():
            ...
            tumor_similarity = torch.sum(embedding_teacher_tumor_vector * embedding_student_tumor_vector, dim=1)
            kidney_similarity = torch.sum(embedding_teacher_kidney_vector * embedding_student_tumor_vector, dim=1)

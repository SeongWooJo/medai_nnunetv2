...
class caseby_DCGAN_DANNTrainer(nnUNetTrainer):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        #with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
            ...
            cect_output, cect_domain_output_list = self.network(cect_data)
    ...
    def validation_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
            ...
            _, cect_domain_output_list = self.network(cect_data)
            del ncct_data
            del cect_data

...
class KDFeatured_Trainer(nnUNetTrainer):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if 0 else dummy_context():
            ...
            teacher_output, teacher_origin_features, _ = self.teacher_network(data_1)           # CECT
            
            # Forward pass with the student model
            student_output, student_origin_features, _ = self.network(data_0)                       # NCCT

...
class featured_embedding_divergence_cos_similiar_Trainer(nnUNetTrainer):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        kidney_masks = []
        tumor_masks = []
        kidney_positions_list = []
        tumor_positions_list = []
        for target_elem in target:
            ...
            kidney_positions_list.append(kidney_positions)
            tumor_positions_list.append(tumor_positions)
            kidney_masks.append(current_kidney_mask)
            tumor_masks.append(current_tumor_mask)    
        
        random_sample_nums = 100000
        sim_loss_list = []
        weights = None
        ...
        for weight, kidney_mask, tumor_mask, kidney_positions, tumor_positions, teacher_feature, student_feature in zip(weights, kidney_masks, tumor_masks, kidney_positions_list, tumor_positions_list, teacher_features, student_features):
            ...
            if contrast_condition:
                ...
                for batch_num in range(0,batch_size):
                    ...
                    tumor_depth_idx1, tumor_height_idx1, tumor_width_idx1 = sample_tumor_pos1[:, 1], sample_tumor_pos1[:, 2], sample_tumor_pos1[:, 3]
                    tumor_depth_idx2, tumor_height_idx2, tumor_width_idx2 = sample_tumor_pos2[:, 1], sample_tumor_pos2[:, 2], sample_tumor_pos2[:, 3]
                        
                    teacher_tumor_vector1 = teacher_tumor_feature[batch_num, :, tumor_depth_idx1, tumor_height_idx1, tumor_width_idx1].T
                    teacher_tumor_vector2 = teacher_tumor_feature[batch_num, :, tumor_depth_idx2, tumor_height_idx2, tumor_width_idx2].T
                     
                    student_tumor_vector1 = student_tumor_feature[batch_num, :, tumor_depth_idx1, tumor_height_idx1, tumor_width_idx1].T
                    student_tumor_vector2 = student_tumor_feature[batch_num, :, tumor_depth_idx2, tumor_height_idx2, tumor_width_idx2].T
                    
                    batch_teacher_tumor_vectors[batch_num] = teacher_tumor_vector1 - teacher_tumor_vector2
                    batch_student_tumor_vectors[batch_num] = student_tumor_vector1 - student_tumor_vector2
                    ...
                    batch_expanded_student_tumor_vectors[batch_num] = teacher_kidney_vector - teacher_tumor_vector1
                    batch_student_kidney_vectors[batch_num] = student_kidney_vector - student_tumor_vector1
        ...
        return {'loss': student_l.detach().cpu().numpy()}

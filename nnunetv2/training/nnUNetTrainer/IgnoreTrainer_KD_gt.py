...
class IgnoreTrainer_KD_fg(nnUNetTrainer):
    ...
    def build_teacher_network_architecture(architecture_class_name: str,
        ...
        pretrain_network = torch.load("/data/seongwoo/nnunetFrame/nnunet_results/Dataset601_Kits19_gt_concat_CECT/IgnoreTrainer__nnUNetPlans__3d_cascade_fullres/fold_0/checkpoint_final.pth")['network_weights']
